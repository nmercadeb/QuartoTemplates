...
**Built base cohorts**
*Cohort construction based on concept sets or demographic requirements on the database population.*
...
*Impose study specific inclusion and exclusion criteria to cohorts in the database.*
...
*Modify start and end dates of subject's in a cohort.*
...
**Cohort manipulation**
*Generate new cohorts by manipulating a set of cohorts in the database.*
...
```{r}
attrition(cdm$diclofenac_match)
```
...
::: title-slide-logos
<img src="logoCC.png" alt="Logo 1" class="logo"/> 
<img src="logoHDS.png" alt="Logo 2" class="logo"/> 
<img src="logoOHDSI.png" alt="Logo 3" class="logo"/>
:::
